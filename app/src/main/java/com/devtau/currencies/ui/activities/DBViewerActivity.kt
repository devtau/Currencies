package com.devtau.currencies.ui.activities
...
import com.devtau.currencies.data.SQLHelper
...
class DBViewerActivity: AppCompatActivity() {
    ...
    private var tableRowParams: LayoutParams? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tableRowParams = LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT)
    ...
    companion object {
        private const val ROWS_PER_PAGE = 100
    }
}